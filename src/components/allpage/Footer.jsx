...
const Footer = () => {
  return (
    <div>
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <div>
              ...
              <strong>Phone:</strong> <span className='select-all'>+8801500000000</span><br />
              <strong>Email:</strong> <span className='select-all'>info@championschoice.com</span>
            </div>
          </div>
      ...
      <footer className="footer sm:footer-horizontal footer-center bg-[#191e25] text-white p-4">
        <aside>
